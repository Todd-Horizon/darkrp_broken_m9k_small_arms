...
SWEP.Gun = ("m9k_colt1911_broken") -- must be the name of your swep but NO CAPITALS!
if (GetConVar(SWEP.Gun.."_allowed")) != nil then
	if not (GetConVar(SWEP.Gun.."_allowed"):GetBool()) then SWEP.Base = "bobs_blacklisted" SWEP.PrintName = SWEP.Gun return end
end
SWEP.Category				= "Broken M9K Small Arms"
SWEP.Author				= "SycoLogic"
SWEP.Contact				= ""
SWEP.Purpose				= "To break M9K"
SWEP.Instructions				= "Hold Mouse 1"
SWEP.MuzzleAttachment			= "1" 	-- Should be "1" for CSS models or "muzzle" for hl2 models
SWEP.ShellEjectAttachment			= "2" 	-- Should be "2" for CSS models or "1" for hl2 models
SWEP.PrintName				= "Broken Colt 1911"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 3000			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 2000		-- Size of a clip
...
SWEP.Primary.Damage		= 50000	-- Base damage per bullet
