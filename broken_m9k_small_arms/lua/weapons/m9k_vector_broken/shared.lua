...
SWEP.Gun = ("m9k_vector_broken") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Broken KRISS Vector"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 9000			-- This is in Rounds Per Minute
