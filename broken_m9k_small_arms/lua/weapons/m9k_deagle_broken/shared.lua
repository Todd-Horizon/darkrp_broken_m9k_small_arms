...
SWEP.Gun = ("m9k_deagle_broken") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Broken Desert Eagle"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.RPM			= 99999			-- This is in Rounds Per Minute
...
SWEP.Primary.Damage		= 9000	-- Base damage per bullet
